...
void GCContent::InitialiseVars(void){
	...
	ifstream ifile("GCText_mm9_chr_offsets.txt");
	
	ifstream GCtextbin("GCtext_mm9.binary", ios::binary);
...
ifstream file ("gc5Base.wib", ios::in | ios::binary | ios::ate);
