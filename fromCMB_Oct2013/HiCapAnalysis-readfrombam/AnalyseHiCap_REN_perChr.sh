...
echo ./AnalyseHiCap_perChr Experiments_HiC.REN.txt 1 1000 mE_HiCap_REN_$chrname\_ $chrname
./AnalyseHiCap_perChr Experiments_HiC.REN.txt 1 1000 mE_HiCap_REN_$chrname\_ $chrname >mE_HiCap_REN_$chrname\.out &
