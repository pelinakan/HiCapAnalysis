...
#include "PromoterClass_ProcessSAMFiles_onlyPromPromInts.h"
...
//-------------------//------------------------------
	...
	int NofExperiments = ExperimentNo;

	EnrichedBins.PrintAllInteractions(Promoters,NegativeControls,BaseFileName, NofExperiments, ExperimentNames); //In one file
//	EnrichedBins.PrintNearestPromoter(Promoters,NofExperiments);
